...
class SelectDeliveryTimePage extends StatefulWidget {
  ...
  @override
  State<SelectDeliveryTimePage> createState() =>
      _SelectDeliveryTimePageState();
}

class _SelectDeliveryTimePageState
    extends State<SelectDeliveryTimePage> {
  (int, int)? _selected;
  ...
  final List<String> _slotLabels = const [
    '9-12',
    '12-15',
    '15-18',
    '18-21'
