...
class ProductDetailPage extends StatelessWidget {
  ...
  const ProductDetailPage(this.product, this.iMat, {super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'jämförelse pris ${product.price.toStringAsFixed(2)} kr/${product.unit}',
          ...
          // ── Bottom green bar ──────────────────────────────────
          Container(height: 16, color: AppTheme.mainColor),
        ],
      ),

      floatingActionButton: const ImatBackButton(),
